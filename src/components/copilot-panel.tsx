  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
      <div className="flex items-center justify-between">
        <div>
          <div className="text-xs uppercase tracking-[0.24em] text-cyan-200/70">AI co-pilot</div>
          <h2 className="mt-2 text-2xl font-semibold text-white">Diagnose with Gemini</h2>
        </div>
      ...
      <form onSubmit={submit} className="mt-6 space-y-3">
        <textarea
          ...
          placeholder="What's wrong with the cluster? e.g., why is buildos-api restarting?"
          rows={3}
          maxLength={4000}
